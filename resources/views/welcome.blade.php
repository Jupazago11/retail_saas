                    ...
                    <section class="space-y-8">
                        ...
                        <div class="space-y-5">
                            <h1 class="max-w-4xl text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl">
                                Retail SaaS para tiendas, minimercados y operacion comercial diaria.
                            </h1>
                        ...
                        <div class="flex flex-wrap gap-4">
                            @auth
                                <a href="{{ route('dashboard') }}" class="inline-flex items-center rounded-2xl bg-amber-400 px-5 py-3 text-sm font-semibold text-stone-950 transition hover:bg-amber-300">
                                    Entrar al dashboard
                                </a>
                            @else
                                <a href="{{ route('login') }}" class="inline-flex items-center rounded-2xl bg-amber-400 px-5 py-3 text-sm font-semibold text-stone-950 transition hover:bg-amber-300">
                                    Iniciar sesion
                                </a>
                                <a href="{{ route('register') }}" class="inline-flex items-center rounded-2xl border border-stone-600 px-5 py-3 text-sm font-semibold text-white transition hover:border-stone-400 hover:bg-white/5">
                                    Crear cuenta
                                </a>
                            @endauth
                        </div>
