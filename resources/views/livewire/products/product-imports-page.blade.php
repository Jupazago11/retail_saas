    ...
    <div class="mx-auto max-w-5xl space-y-6 px-4 sm:px-6 lg:px-8">
        <div class="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                ...
                <h3 class="mt-2 text-2xl font-black text-gray-900">Importador de catalogo</h3>
                <p class="mt-3 text-sm leading-6 text-gray-600">
                    Encabezados minimos: <span class="font-semibold text-gray-800">name, category_code, unit_code, cost, price_1</span>.
            ...
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                ...
                <pre class="mt-4 overflow-x-auto rounded-lg bg-stone-950 p-4 text-xs leading-6 text-stone-100">name,category_code,unit_code,cost,price_1,brand_name,sku,barcode,minimum_stock,tracks_inventory,status
