    ...
    <div class="mx-auto max-w-5xl space-y-6 px-4 sm:px-6 lg:px-8">
        <div class="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
                ...
                <h3 class="mt-2 text-2xl font-black text-stone-900">Importador de catalogo</h3>
                <p class="mt-3 text-sm leading-6 text-stone-600">
                    Encabezados minimos: <span class="font-semibold text-stone-800">name, category_code, unit_code, cost, price_1</span>.
                    Columnas opcionales: brand_name, sku, barcode, tax_id, description, price_2, price_3, tracks_inventory, minimum_stock y status.
                </p>

                <form wire:submit="import" class="mt-6 space-y-4">
                    <div>
                        <label for="products-import-file" class="text-sm font-medium text-stone-700">Archivo CSV</label>
                        <input wire:model="importFile" id="products-import-file" type="file" accept=".csv,text/csv,.txt" class="mt-1 block w-full rounded-2xl border-stone-300 shadow-sm focus:border-amber-500 focus:ring-amber-500">
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
                ...
                <pre class="mt-4 overflow-x-auto rounded-2xl bg-stone-950 p-4 text-xs leading-6 text-stone-100">name,category_code,unit_code,cost,price_1,brand_name,sku,barcode,minimum_stock,tracks_inventory,status
Arroz 500g,ABA,UND,1800,2500,Mi Marca,ARR-500,770100000001,3,true,active
Cereal 1kg,DES,UND,6200,8100,,CER-001,,2,true,inactive</pre>
            </div>
        </div>
