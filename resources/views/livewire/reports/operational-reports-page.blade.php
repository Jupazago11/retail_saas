<div class="py-10">
    <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            <div>
                <p class="text-sm font-semibold uppercase tracking-[0.22em] text-blue-700">Tendencia</p>
                <h3 class="mt-2 text-2xl font-black text-gray-900">Ventas por dia</h3>
            </div>
                ...
                <div class="mt-6 space-y-3">
                    @forelse ($paymentMethodBreakdown as $method)
                        <div class="rounded-lg bg-gray-50 p-4 ring-1 ring-gray-200">
                            <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                                <div>
                                    <p class="text-sm font-black text-gray-900">{{ $method['payment_method_label'] }}</p>
                                    <p class="mt-1 text-sm text-gray-600">{{ $method['payments_count'] }} movimientos confirmados</p>
                                </div>
                                <p class="text-sm text-gray-600">Total: <span class="font-medium text-gray-900">${{ $method['payments_total'] }}</span></p>
                            </div>
                        </div>
                    @empty
                        <div class="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-8 text-center text-gray-500">
