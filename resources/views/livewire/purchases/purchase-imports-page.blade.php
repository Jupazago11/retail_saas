    ...
    <div class="mx-auto max-w-6xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                <p class="text-sm font-semibold uppercase tracking-[0.22em] text-blue-700">Documento base</p>
                <h3 class="mt-2 text-2xl font-black text-gray-900">Contexto de compra</h3>

                <form wire:submit="import" class="mt-6 space-y-5">
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div>
                            <label for="purchase-import-branch" class="text-sm font-medium text-gray-700">Sucursal</label>
                            <select wire:model.live="branchId" id="purchase-import-branch" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-600 focus:ring-blue-600">
                        ...
                        <div>
                            <label for="purchase-import-warehouse" class="text-sm font-medium text-gray-700">Bodega</label>
                            <select wire:model="warehouseId" id="purchase-import-warehouse" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-600 focus:ring-blue-600">
                                <option value="">Selecciona</option>
                        ...
                        <div>
                            <label for="purchase-import-supplier" class="text-sm font-medium text-gray-700">Proveedor formal</label>
                            <select wire:model="supplierId" id="purchase-import-supplier" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-600 focus:ring-blue-600">
            ...
            <div class="space-y-6">
                <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <p class="mt-3 text-sm leading-6 text-gray-600">
                        Columnas minimas: <span class="font-semibold text-gray-800">product_sku, quantity, unit_cost</span>.
                        Opcionales: <span class="font-semibold text-gray-800">presentation_name, variant_sku, tax_rate</span>.
                    </p>
                    <pre class="mt-4 overflow-x-auto rounded-lg bg-stone-950 p-4 text-xs leading-6 text-stone-100">product_sku,presentation_name,variant_sku,quantity,unit_cost,tax_rate
ARR-500,,,12,1800,19
JUG-001,Pack x 6,CON-PULPA,3,8200,19</pre>
                ...
                <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <div class="mt-4 space-y-2 text-sm text-gray-600">
                        ...
                        <p>Compra creada: <span class="font-semibold text-gray-900">{{ $summary['purchase_id'] ?? 'No creada' }}</span></p>
                    </div>
