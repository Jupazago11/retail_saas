    ...
    <div class="mx-auto max-w-5xl space-y-6 px-4 sm:px-6 lg:px-8">
        <div class="grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                ...
                <h3 class="mt-2 text-2xl font-black text-gray-900">Importador de clientes</h3>
                ...
                <form wire:submit="import" class="mt-6 space-y-4">
                    <div>
                        <label for="customer-import-file" class="text-sm font-medium text-gray-700">Archivo CSV</label>
                        <input wire:model="importFile" id="customer-import-file" type="file" accept=".csv,text/csv,.txt" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-600 focus:ring-blue-600">
            ...
            <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                ...
                <pre class="mt-4 overflow-x-auto rounded-lg bg-stone-950 p-4 text-xs leading-6 text-stone-100">first_name,last_name,document_type,document_number,phone,email,status,credit_enabled,credit_limit,loyalty_enabled
