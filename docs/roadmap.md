...
- Refinar UI y flujo de asignacion de `company_roles` a usuarios empresariales (el catalogo global de `role_templates` se elimino; cada empresa arma sus propios roles).
